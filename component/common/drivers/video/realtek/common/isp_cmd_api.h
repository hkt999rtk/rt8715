...
extern int isp_set_gpio_dir(int index,char direct);
extern int isp_get_gpio_dir(int index,char *direct);
extern int isp_set_gpio_value(int index,char value);
extern int isp_get_gpio_value(int index,char *value);

extern void isp_set_sensor_fps(int a_dValue);
extern void isp_set_Init_ExposureTime(unsigned int Exp,unsigned int gain);
extern void isp_get_memory(unsigned char *xbuf,unsigned short xmem_addr,unsigned int len);
extern void isp_set_memory(unsigned char *xbuf,unsigned short xmem_addr,unsigned int len);
#endif
