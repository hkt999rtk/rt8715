...
#define ISP_STREAM_0   (0)
#define ISP_STREAM_1   (1)
#define ISP_STREAM_2   (2)
...
typedef struct isp_init_cfg_s {
	...
	int isp_fw_space;
	unsigned int isp_user_space_addr;
	unsigned int isp_user_space_size;
        int isp_flip;
        unsigned char sensor_table[8];//Support 8 sensor , the end flag need to set the 0xff
