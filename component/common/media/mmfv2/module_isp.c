...
static int isp_get_sensor_clock(int sensor_id)
{
	...
	if(sensor_id== SENSOR_OV2735)
	  ...
	  snesor_clock = ISP_FREQ_24;
	else if(sensor_id ==  SENSOR_OV9732)
	  snesor_clock = ISP_FREQ_24;
	else{
		snesor_clock = -1;
...
int isp_video_sensor_check(int SensorName){
	...
	if(SensorName == SENSOR_SC2232){
		...
		if(sendor_id[0] == 0x22 && sendor_id[1] == 0x32){
			...
			printf("it is not SC2232!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
		...
		if(sendor_id[0]== 0x27 && sendor_id[1]== 0x35 ){
			...
			printf("it is not OV2735!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
	...
	isp_hm_2140_power_on();
		...
		if(sendor_id[0]== 0x21 && sendor_id[1]== 0x40 ){
			...
			printf("it is not HM2140!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
	...
	isp_imx_307_power_on();
		...
		if(sendor_id[0]== 0x10 && sendor_id[1]== 0xA0 ){
			...
			printf("it is not IMX307!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}		
		...
		if(sendor_id[0] == 0x32 && sendor_id[1] == 0x35){
			...
			printf("it is not SC4236!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
		...
		if(sendor_id[0] == 0x20 && sendor_id[1] == 0x53){
			...
			printf("it is not GC2053!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
		...
		if(sendor_id[0] == 0x27 && sendor_id[1] == 0x40){
			...
			printf("it is not OV2740!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
		...
		if(sendor_id[0] == 0x0F && sendor_id[1] == 0x37){
			...
			printf("it is not JXF37!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
		...
		if(sendor_id[0] == 0xCB && sendor_id[1] == 0x07){
			...
			printf("it is not SC2232H!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
		...
		if(sendor_id[0] == 0x30 && sendor_id[1] == 0x04){
			...
			printf("it is not GL3004!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
	}
	...
	isp_sc_2239_power_on();
		...
		if(sendor_id[0] == 0xCB && sendor_id[1] == 0x10){
			...
			printf("it is not SC2239!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
	}
	...
	isp_ps_5260_power_on();
		...
		if(sendor_id[0] == 0x52 && sendor_id[1] == 0x60){
			...
			printf("it is not PS5260!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
	}
		...
		if(sendor_id[0] == 0x10 && sendor_id[1] == 0x54){
			...
			printf("it is not GC1054!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
	...
	isp_ps_5268_power_on();
		...
		if(sendor_id[0] == 0x52 && sendor_id[1] == 0x68){
			...
			printf("it is not PS5268!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
	}
		...
		if(sendor_id[0] == 0x52 && sendor_id[1] == 0x70){
			...
			printf("it is not PS5270!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
	}
	...
	isp_ov_5640_power_on();
		...
		if(sendor_id[0] == 0x56 && sendor_id[1] == 0x40){
			...
			printf("it is not OV5640!,please check sensor.h and isp.bin!, Sendor_id[0]=0x%x, Sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
			return -1;
		}
	}
	else if(SensorName == SENSOR_OV9732){
		unsigned char sendor_id[2];
		sendor_id[0] = isp_i2c_read_byte(0x300A);
		sendor_id[1] = isp_i2c_read_byte(0x300B);
		printf("sendor_id[0]=0x%x, sendor_id[1]=0x%x\n\r", sendor_id[0], sendor_id[1]);
		if(sendor_id[0] == 0x97 || sendor_id[1] == 0x32){
			return 0;
		}else{
			printf("it is not OV9732!,please check sensor.h and isp.bin!\n\r");
			return -1;
		}
	}
	else{
