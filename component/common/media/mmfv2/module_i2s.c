...
static void i2s_rx_complete(uint32_t arg, uint8_t *pbuf)
{
	...
	if(ctx->params.enable_aec){
        //printf("\n\renable_aec\n\r");
		int shrink_size = shrink_data((void*)pbuf, (void*)last_rx_buf, AUDIO_DMA_PAGE_SIZE, ctx);
...
void* i2s_create(void* parent)
{
	...
	// Init TX,RX dma
	i2s_set_dma_buffer(ctx->i2s_obj, (void*)dma_txdata, (void*)dma_rxdata, AUDIO_DMA_PAGE_NUM, AUDIO_DMA_PAGE_SIZE);
