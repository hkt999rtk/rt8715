...
#define CMD_MP4_SET_WRITE_CB            MM_MODULE_CMD(0x18)
#define CMD_MP4_SET_OPEN_CB            MM_MODULE_CMD(0x19)
#define CMD_MP4_SET_SEEK_CB            MM_MODULE_CMD(0x1a)
#define CMD_MP4_SET_CLOSE_CB            MM_MODULE_CMD(0x1b)
