...
struct UVC_FRAME_FRAMEBASED(3) uvc_frame_h265_720p = {
	...
	.wWidth			= cpu_to_le16(1280),
	.wHeight		= cpu_to_le16(720),
	.dwMinBitRate		= cpu_to_le32(1280*720*9),
	.dwMaxBitRate		= cpu_to_le32(1280*720*27),
	.dwDefaultFrameInterval	= cpu_to_le32(400000),
	.bFrameIntervalType	= 3,
        .dwBytesPerLine 	= cpu_to_le32(0),
	.dwFrameInterval[0]	= cpu_to_le32(400000),
...
struct uvc_frame_info uvc_frames_h264[] = {//25, 
	{  MAX_W, MAX_H, { VALUE_FPS(25), VALUE_FPS(10), VALUE_FPS(2), 0 }, },//400000, 1000000, 5000000,
	{ 0, 0, { 0, }, },
};

struct uvc_frame_info uvc_frames_h265[] = {//25, 
	{  1280, 720, { VALUE_FPS(25), VALUE_FPS(10), VALUE_FPS(2), 0 }, },//400000, 1000000, 5000000,
	{ 0, 0, { 0, }, },
};
