...
#include "module_wrtc_peer.h"
#include "module_wrtc_rtp.h"
#endif
...
// V1
//------------------------------------------------------------------------------
#define V1_FPS						15 //Default is recording
#define V1_RESOLUTION				VIDEO_1080P
#define V1_HW_SLOT					1
#define V1_SW_SLOT					3
// H264
#define V1_BITRATE					1*1024*1024
#define V1_H264_RCMODE				RC_MODE_H264VBR
//#define V1_H264_QUEUE_LEN			(V1_FPS*(V2_MEM_BUF_SEC))
#if ISP_BOOT_MODE_ENABLE
#define V1_MEM_BUF_SEC				20
#else
...
// V2
//------------------------------------------------------------------------------
#define V2_FPS						30 //Default is streaming
#define V2_RESOLUTION				VIDEO_720P
#define V2_HW_SLOT					1
#define V2_SW_SLOT					3 //fps 30 need set 3

// H264
#define V2_BITRATE					2*1024*1024
//#if ISP_BOOT_MODE_ENABLE
...
#define V2_H264_QUEUE_LEN			6


#elif defined(ENABLE_WRTC_PEER_MMFV2)

//------------------------------------------------------------------------------
// V1
//------------------------------------------------------------------------------
#define V1_FPS						30 //Default is recording
#define V1_RESOLUTION				VIDEO_480P
//#define V1_RESOLUTION				VIDEO_720P //should use H264ENCODER_LEVEL_3_1


#define V1_HW_SLOT					1
#define V1_SW_SLOT					3
// H264
#define V1_BITRATE					256*1024*1

#define V1_MEM_BUF_SEC				10
#define V1_H264_RCMODE				RC_MODE_H264CBR

#define V1_H264_QUEUE_LEN			12
...
#elif V1_RESOLUTION == VIDEO_1440SQR
	#define V1_WIDTH	VIDEO_1440SQR_WIDTH
	#define V1_HEIGHT	VIDEO_1440SQR_HEIGHT
#endif
...
#elif V2_RESOLUTION == VIDEO_1440SQR
	#define V2_WIDTH	VIDEO_1440SQR_WIDTH
	#define V2_HEIGHT	VIDEO_1440SQR_HEIGHT
#endif
...
#elif V3_RESOLUTION == VIDEO_1440SQR
	#define V3_WIDTH	VIDEO_1440SQR_WIDTH
	#define V3_HEIGHT	VIDEO_1440SQR_HEIGHT
#endif
...
extern wrtc_peer_params_t wrtc_peer_a_params;
extern wrtc_peer_params_t wrtc_peer_v_params;
#endif
...
extern dup_params_t dup_params;
extern array_params_t h265_array_params;


#ifdef ENABLE_WRTC_PEER_MMFV2
extern mm_context_t* mmwrtc_peer_ctx;
extern mm_context_t* mmwrtc_rtp_ctx;
extern mm_siso_t* siso_g711_wrtc_peer;
extern mm_siso_t* siso_audio_g711;
extern mm_miso_t* miso_h264_g711_wrtc_peer;
#endif
...
extern mm_context_t* dup_ctx;
extern mm_siso_t* siso_audio_dup;
