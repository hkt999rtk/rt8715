...
#else
typedef enum {
    AUDIO_CODEC_1p8V  = 0x5F,
    AUDIO_CODEC_2p8V  = 0x20,
    AUDIO_CODEC_2p78V = 0x22,    
    AUDIO_CODEC_2p75V = 0x24,       
    AUDIO_CODEC_2p72V = 0x26,      
    AUDIO_CODEC_2p69V = 0x28,   
    AUDIO_CODEC_2p68V = 0x2A,       
    AUDIO_CODEC_2p64V = 0x2C,   
    AUDIO_CODEC_2p61V = 0x2E,          
    AUDIO_CODEC_2p58V = 0x30,     
    AUDIO_CODEC_2p56V = 0x32,      
    AUDIO_CODEC_2p53V = 0x34,          
} audio_power_sel;
#endif
