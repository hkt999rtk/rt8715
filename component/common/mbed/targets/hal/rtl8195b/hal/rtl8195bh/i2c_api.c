...
static const PinMap PinMap_I2C_SDA[] = {
    {PB_0,  RTL_PIN_PERI(PID_I2C0, 0, PinSel0), RTL_PIN_FUNC(PID_I2C0, PinSel0)},
    {PG_4,  RTL_PIN_PERI(PID_I2C0, 0, PinSel1), RTL_PIN_FUNC(PID_I2C0, PinSel1)},
    {PH_2,  RTL_PIN_PERI(PID_I2C0, 0, PinSel2), RTL_PIN_FUNC(PID_I2C0, PinSel2)},
    
    {PB_2,  RTL_PIN_PERI(PID_I2C2, 2, PinSel0), RTL_PIN_FUNC(PID_I2C2, PinSel0)},
    {PG_6,  RTL_PIN_PERI(PID_I2C2, 2, PinSel1), RTL_PIN_FUNC(PID_I2C2, PinSel1)},
    {PE_14, RTL_PIN_PERI(PID_I2C2, 2, PinSel2), RTL_PIN_FUNC(PID_I2C2, PinSel2)},
    
    {PB_4,  RTL_PIN_PERI(PID_I2C3, 3, PinSel0), RTL_PIN_FUNC(PID_I2C3, PinSel0)},
    {PG_8,  RTL_PIN_PERI(PID_I2C3, 3, PinSel1), RTL_PIN_FUNC(PID_I2C3, PinSel1)},
    {PF_10, RTL_PIN_PERI(PID_I2C3, 3, PinSel2), RTL_PIN_FUNC(PID_I2C3, PinSel2)},
    {NC,    NC,     0}
};

static const PinMap PinMap_I2C_SCL[] = {
    {PB_1,  RTL_PIN_PERI(PID_I2C0, 0, PinSel0), RTL_PIN_FUNC(PID_I2C0, PinSel0)},
    {PG_5,  RTL_PIN_PERI(PID_I2C0, 0, PinSel1), RTL_PIN_FUNC(PID_I2C0, PinSel1)},
    {PH_3,  RTL_PIN_PERI(PID_I2C0, 0, PinSel2), RTL_PIN_FUNC(PID_I2C0, PinSel2)},
    
    {PB_3,  RTL_PIN_PERI(PID_I2C2, 2, PinSel0), RTL_PIN_FUNC(PID_I2C2, PinSel0)},
    {PG_7,  RTL_PIN_PERI(PID_I2C2, 2, PinSel1), RTL_PIN_FUNC(PID_I2C2, PinSel1)},
    {PE_15, RTL_PIN_PERI(PID_I2C2, 2, PinSel2), RTL_PIN_FUNC(PID_I2C2, PinSel2)},
    
    {PB_5,  RTL_PIN_PERI(PID_I2C3, 3, PinSel0), RTL_PIN_FUNC(PID_I2C3, PinSel0)},
    {PG_9,  RTL_PIN_PERI(PID_I2C3, 3, PinSel1), RTL_PIN_FUNC(PID_I2C3, PinSel1)},
    {PF_4,  RTL_PIN_PERI(PID_I2C3, 3, PinSel2), RTL_PIN_FUNC(PID_I2C3, PinSel2)},
    {NC,    NC,     0}
};
