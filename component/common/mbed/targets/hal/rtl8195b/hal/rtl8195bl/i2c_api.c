...
static const PinMap PinMap_I2C_SDA[] = {
    ...
    {PA_4,  RTL_PIN_PERI(PID_I2C0, 0, PinSel1), RTL_PIN_FUNC(PID_I2C0, PinSel1)},
    {PA_7,  RTL_PIN_PERI(PID_I2C0, 0, PinSel2), RTL_PIN_FUNC(PID_I2C0, PinSel2)},
    {PA_9,  RTL_PIN_PERI(PID_I2C0, 0, PinSel3), RTL_PIN_FUNC(PID_I2C0, PinSel3)},
...
static const PinMap PinMap_I2C_SCL[] = {
    ...
    {PA_5,  RTL_PIN_PERI(PID_I2C0, 0, PinSel1), RTL_PIN_FUNC(PID_I2C0, PinSel1)},
    {PA_8,  RTL_PIN_PERI(PID_I2C0, 0, PinSel2), RTL_PIN_FUNC(PID_I2C0, PinSel2)},
    {PA_10, RTL_PIN_PERI(PID_I2C0, 0, PinSel3), RTL_PIN_FUNC(PID_I2C0, PinSel3)},
...
void i2c_init(i2c_t *obj, PinName sda, PinName scl)
{
    ...
    //obj->i2c_adp.pltf_dat.tr_time_out = LP_I2C_TIMEOUT_DISABLE;
...
int i2c_read(i2c_t *obj, int address, char *data, int length, int stop)
{
    ...
    if (hal_i2c_receive(phal_i2c_adapter) != HAL_OK) {
        ...
        phal_i2c_adapter->pltf_dat.tr_time_out = LP_I2C_TIMEOUT_DISABLE;
        while ((phal_i2c_adapter->status == I2CStatusRxReady) || (phal_i2c_adapter->status == I2CStatusRxing)) {
            if (hal_i2c_timeout_chk(phal_i2c_adapter, i2c_time_start)) {
                if (phal_i2c_adapter->pltf_dat.tr_time_out != LP_I2C_TIMEOUT_DISABLE) {
