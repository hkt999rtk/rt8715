...
#ifndef _RTL8195BLP_UART_TYPE_H_
#define _RTL8195BLP_UART_TYPE_H_
...
/**
 * @addtogroup ls_hal_uart_reg UART Registers.
 * @ingroup ls_hal_uart
 * @{
 */
...
#endif    // end of #ifndef _RTL8195BLP_UART_TYPE_H_
