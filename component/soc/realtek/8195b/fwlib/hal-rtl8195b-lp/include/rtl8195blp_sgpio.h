...
#ifndef _RTL8195BLP_SGPIO_H_
#define _RTL8195BLP_SGPIO_H_

/** 
 * @addtogroup ls_hal_sgpio SGPIO
 * @{
 */

#include "basic_types.h"
#include "rtl8195blp_sgpio_type.h"

#define REG_PERI_MULFDATA   0x074 

#define SGPIO_LP_SCLK_NS    500.0f 
...
typedef uint8_t sgpio_id_t;

/**
  \brief SGPIO application pin mux selection. 
*/
enum  sgpio_pin_sel_lp_e
{
    Sgpio_PinSel_lp_0           = 0,  
    Sgpio_PinSel_lp_1           = 1,
    Sgpio_NoPinSel_lp_OnlyTimer = 2,
    Sgpio_PinSel_lp_Max         = 3
};
typedef uint8_t sgpio_pin_sel_lp_t;
...
/**
  \brief  The data structure for an SGPIO port HAL operations.
*/
typedef struct hal_sgpio_adapter_s {
    SGPIO_Type *base_addr;                  /*!< The SGPIO common register base address */
    sgpio_pin_sel_lp_t sgpio_pin_sel;       /*!< SGPIO application pin mux selection */
...
typedef struct hal_sgpio_group_adapter_s {
    ...
    hal_sgpio_adapter_t *psgpio_adapter[MaxSgpioNum];   /*!< All the SGPIO adapters of this platform */
    irq_handler_t   irq_fun[MaxSgpioNum];               /*!< the IRQ handler for different SGPIO adapters */
...
/** 
 * @addtogroup ls_hal_sgpio_rom_func SGPIO HAL ROM APIs.
 * @{
 */

void hal_sgpio_irq_handler_rtl8195blp (void *hid);
void hal_sgpio_irq_reg_rtl8195blp (irq_handler_t handler);
void hal_sgpio_unreg_rtl8195blp (void);
void hal_sgpio_reg_cb_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_irq_user_cb_t callback, void *arg, sgpio_irq_shift_t irq_shift);
void hal_sgpio_unreg_cb_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_irq_shift_t irq_shift);
HAL_Status hal_sgpio_init_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_pin_sel_lp_t pin_sel);
void hal_sgpio_deinit_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp);
void hal_sgpio_enter_critical_rtl8195blp (void); 
void hal_sgpio_exit_critical_rtl8195blp (void); 
void hal_sgpio_set_rxtc_stop_ctrl_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_rxtc_event_t *prxtc_event);
void hal_sgpio_get_rxtc_stop_ctrl_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_rxtc_event_t *prxtc_event);
void hal_sgpio_set_rxtc_reset_ctrl_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_rxtc_event_t *prxtc_event);
void hal_sgpio_get_rxtc_reset_ctrl_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_rxtc_event_t *prxtc_event);
void hal_sgpio_set_rxtc_match_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_rxtc_match_event_t match_event, u16 match_value);
void hal_sgpio_set_rxtc_int_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp,  sgpio_rxtc_match_event_t match_event, hal_sgpio_set_irq_t *psgpio_set_irq);
void hal_sgpio_set_capture_ctrl_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_capture_type_t capture_type, BOOL cap_en);
void hal_sgpio_set_capture_compare_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u8 cap_cmpval_sel, u16 cap_cmpval);
void hal_sgpio_set_capture_int_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_set_irq_t *psgpio_set_irq);
void hal_sgpio_set_multc_stop_ctrl_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_multc_event_t *pmultc_event);
void hal_sgpio_get_multc_stop_ctrl_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_multc_event_t *pmultc_event);
void hal_sgpio_set_multc_reset_ctrl_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_multc_event_t *pmultc_event);
void hal_sgpio_get_multc_reset_ctrl_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_multc_event_t *pmultc_event);
void hal_sgpio_set_multc_match_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_multc_match_group_t match_group, sgpio_multc_match_event_t match_event, u16 match_value);
void hal_sgpio_set_multc_match_event0_int_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_set_irq_t *psgpio_set_irq);
void hal_sgpio_set_multc_match_group_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_multc_match_group_t match_group);
void hal_sgpio_set_multc_fifo_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_fifo_value_t *pfifo_value);
void hal_sgpio_set_rxtc_external_match_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_rxtc_match_event_t match_event, sgpio_external_output_t external_output);
void hal_sgpio_set_multc_external_match_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_multc_match_event_t match_event, sgpio_external_output_t external_output);
void hal_sgpio_set_multc_match_event0_cnt_int_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, BOOL match_cnt_en, u8 match_down_cnt, hal_sgpio_set_irq_t *psgpio_set_irq);
void hal_sgpio_set_multc_match_event0_cnt_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, BOOL match_cnt_en, u8 match_down_cnt);
void hal_sgpio_init_rxdata_time_sampling_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_sampling_event_t *psampling_event);
void hal_sgpio_deinit_rxdata_time_sampling_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp);
void hal_sgpio_init_rxdata_capture_compare_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_cmp_result_bit_t cmp_result_bit, u16 cap_cmpval);
void hal_sgpio_deinit_rxdata_capture_compare_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp);
HAL_Status hal_sgpio_set_rxdata_load_int_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u8 bit_length, hal_sgpio_set_irq_t *psgpio_set_irq);
void hal_sgpio_set_rxdata_prebuf_bit_shift_int_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_set_irq_t *psgpio_set_irq);
void hal_sgpio_reset_rxdata_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp);
void hal_sgpio_set_rxdata_match_int_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, BOOL rxdata_match_en, u32 match_value, hal_sgpio_set_irq_t *psgpio_set_irq);
HAL_Status hal_sgpio_set_txdata_bit_length_int_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u8 bit_length, hal_sgpio_set_irq_t *psgpio_set_irq);
void hal_sgpio_set_txdata_prebuf_bit_shift_int_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_set_irq_t *psgpio_set_irq);
void hal_sgpio_reset_txdata_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp);
u32 hal_sgpio_set_time_to_rxtc_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_time_unit_t time_unit, u32 time_value);
u32 hal_sgpio_set_time_to_multc_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_time_unit_t time_unit, u32 time_value);
u32 hal_sgpio_set_rxtc_to_time_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u16 rxtc_unit, sgpio_time_unit_t time_unit);
u32 hal_sgpio_set_multc_to_time_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u16 multc_unit, sgpio_time_unit_t time_unit);
void hal_sgpio_clean_status_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_is_t sgpio_is);
void hal_sgpio_update_rxtcmr_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_rxtc_match_event_t match_event, u16 old_prescale);
void hal_sgpio_update_multcmr_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_multc_match_group_t match_group, sgpio_multc_match_event_t match_event, u16 old_prescale);
void hal_sgpio_rxtc_timer_mode_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_rxtc_timer_mode_t *psgpio_rxtc_timer_mode);
void hal_sgpio_multc_timer_mode_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_multc_timer_mode_t *psgpio_multc_timer_mode);
void hal_sgpio_multc_counter_mode_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_multc_counter_mode_t *psgpio_multc_counter_mode);
void hal_sgpio_rxtc_timer_match_output_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_rxtc_timer_match_output_t *psgpio_rxtc_timer_match_output);
void hal_sgpio_multc_timer_counter_match_output_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_multc_timer_counter_match_output_t *psgpio_multc_timer_counter_match_output);
void hal_sgpio_rxtc_capture_mode_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_rxtc_capture_mode_t *psgpio_rxtc_capture_mode);
void hal_sgpio_rxtc_capture_timeout_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_rxtc_capture_timeout_t *psgpio_rxtc_capture_timeout);
void hal_sgpio_rxtc_capture_monitor_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_rxtc_capture_monitor_t *psgpio_rxtc_capture_monitor);
u32 hal_sgpio_get_rxtc_capture_time_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_time_unit_t time_unit);
void hal_sgpio_init_rxdata_capture_compare_time_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_cmp_result_bit_t cmp_result_bit, sgpio_time_unit_t time_unit, u32 cap_cmpval_time);
void hal_sgpio_sampling_rxdata_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_sampling_rxdata_t *psgpio_sampling_data);
u32 hal_sgpio_get_input_rxdata_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp);
u32 hal_sgpio_get_arrange_rxdata_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u32 rxdata_tp);
void hal_sgpio_capture_compare_rxdata_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_capture_compare_rxdata_t *psgpio_compare_data);
void hal_sgpio_txdata_bit_symbol_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_txdata_bit_symbol_t *psgpio_txdata_bit_symbol);
void hal_sgpio_txdata_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_txdata_t *psgpio_txdata);
void hal_sgpio_txdata_bit_length_irq_rtl8195blp(void *data);
void hal_sgpio_send_txdata_rtl8195blp(hal_sgpio_adapter_t *psgpio_adp);
void hal_sgpio_reset_receive_rxdata_rtl8195blp(hal_sgpio_adapter_t *psgpio_adp);
void hal_sgpio_disable_rxdata_match_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp);
void hal_sgpio_monitor_rxdata_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_monitor_rxdata_t *pmonitor_rxdata);
void hal_sgpio_multc_fifo_reset_rtl8195blp(hal_sgpio_adapter_t *psgpio_adp);
void hal_sgpio_dma_match_output_irq_handle_rtl8195blp (void *data);
HAL_Status hal_sgpio_dma_match_output_init_rtl8195blp(hal_sgpio_adapter_t *psgpio_adp, hal_gdma_adaptor_t *pgdma_adaptor, hal_sgpio_dma_match_output_t *pdma_match_output);
HAL_Status hal_sgpio_dma_match_output_deinit_rtl8195blp(hal_sgpio_adapter_t *psgpio_adp);
void hal_sgpio_dma_handshake_init_rtl8195blp(hal_sgpio_adapter_t *psgpio_adp, hal_sgpio_dma_match_output_t *pdma_match_output);
void hal_sgpio_dma_preload_data_rtl8195blp(hal_sgpio_adapter_t *psgpio_adp);
void hal_sgpio_dma_send_start_rtl8195blp(hal_sgpio_adapter_t *psgpio_adp);
void hal_sgpio_dma_time_to_multc_rtl8195blp(hal_sgpio_adapter_t *psgpio_adp, u16 *pmemory_addr, u8 reset_cnt, sgpio_time_unit_t time_unit);
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_rxtc_rst_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_rxtc_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u16 rxtc_value)
{
 ...
 */
__STATIC_INLINE
u16 hal_sgpio_get_rxtc_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_rxtc_prescale_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u16 prescale)
{
 ...
 */
__STATIC_INLINE
u16 hal_sgpio_get_rxtc_prescale_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_prerxtc_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u16 prerxtc_value)
{
 ...
 */
__STATIC_INLINE
u16 hal_sgpio_get_prerxtc_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_capture_en_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, BOOL cap_en)
{
 ...
 */
__STATIC_INLINE
u16 hal_sgpio_get_capture_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_rxtc_start_en_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, BOOL start_en)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_rxtc_input_start_ctrl_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_rxtc_input_start_t rxtc_input_start)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_multc_rst_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_multc_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u16 multc_value)
{
 ...
 */
__STATIC_INLINE
u16 hal_sgpio_get_multc_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_multc_prescale_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u16 prescale)
{
 ...
 */
__STATIC_INLINE
u16 hal_sgpio_get_multc_prescale_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_premultc_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u16 premultc_value)
{
    psgpio_adp->base_addr->mulprtc_b.mulprtc = premultc_value;
}   
 ...
 */
__STATIC_INLINE
u16 hal_sgpio_get_premultc_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_multc_start_en_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, BOOL start_en)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_multc_mode_ctrl_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_multc_mode_t multc_mode)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_multc_fifo_mode_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, BOOL fifo_mode_en)
{
 ...
 */
__STATIC_INLINE
u8 hal_sgpio_get_multc_match_event0_cnt_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{  
 ...
 */
__STATIC_INLINE
u32 hal_sgpio_get_rxdata_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
u32 hal_sgpio_get_rxdata_prebuf_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_rxdata_match_mask_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u32 match_mask)
{
 ...
 */
__STATIC_INLINE
u32 hal_sgpio_get_rxdata_match_mask_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_rxdata_direction_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u8 direction)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_rx_in_out_ctrl_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_rx_inoutput_t inoutput)
{
    psgpio_adp->base_addr->mulemr_b.biout = inoutput;       
}
 ...
 */
__STATIC_INLINE
void hal_sgpio_init_txdata_en_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, BOOL txdata_en)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_txdata_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u32 txdata)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_txdata_prebuf_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u32 txdata)
{
 ...
 */
__STATIC_INLINE
u32 hal_sgpio_get_txdata_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
u32 hal_sgpio_get_txdata_prebuf_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_txdata_direction_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, u8 direction)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_output_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp, sgpio_output_value_t value)
{
 ...
 */
__STATIC_INLINE
u32 hal_sgpio_get_output_value_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
void hal_sgpio_set_output_inverse_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
 ...
 */
__STATIC_INLINE
u32 hal_sgpio_get_status_rtl8195blp (hal_sgpio_adapter_t *psgpio_adp)
{
    return (psgpio_adp->base_addr->is);       
}

/** @} */ /* End of group ls_hal_sgpio_rom_func */
...
typedef struct hal_sgpio_func_stubs_s {
    hal_sgpio_group_adapter_t *psgpio_gadapter;
    const uint8_t *psgpio_pin;
    void (*hal_sgpio_irq_handler) (void *hid);
    void (*hal_sgpio_irq_reg) (irq_handler_t handler);
    void (*hal_sgpio_unreg) (void);
    ...
    HAL_Status (*hal_sgpio_init) (hal_sgpio_adapter_t *psgpio_adp, sgpio_pin_sel_lp_t pin_sel);
...
/** @} */ /* End of group ls_hal_sgpio */

#endif  // end of "#define _RTL8195BLP_SGPIO_H_"
