 ...
 *
 */
uint8_t hal_misc_wdt_read_lp_watchdog_flag (void);
 ...
 *  @returns    void
 */
void hal_misc_wdt_enable_lp_watchdog (uint32_t timeout_ms);

/**
 *  @brief ADC PLL init function
 *
 *  @return      void
 *
 */
void hal_adc_pll_init(void);
