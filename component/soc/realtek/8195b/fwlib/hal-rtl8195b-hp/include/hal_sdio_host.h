...
extern hal_status_t hal_sdioh_init_host_rtl8195bhp_patch (hal_sdio_host_adapter_t *psdioh_adapter, sdioh_pin_sel_t pin_sel);
extern hal_status_t hal_sdioh_erase_rtl8195bhp_patch (hal_sdio_host_adapter_t *psdioh_adapter, u64 start_addr, u64 end_addr);
extern hal_status_t hal_sdioh_switch_bus_speed_rtl8195bhp_patch (hal_sdio_host_adapter_t *psdioh_adapter, u8 speed);
extern hal_status_t hal_sdioh_get_supported_speed_rtl8195bhp_patch (hal_sdio_host_adapter_t *psdioh_adapter, u8 *value);
extern hal_status_t hal_sdioh_init_card_rtl8195bhp_patch (hal_sdio_host_adapter_t *psdioh_adapter);
extern void hal_sdioh_deinit_rtl8195bhp_patch (hal_sdio_host_adapter_t *psdioh_adapter);
extern hal_status_t hal_sdioh_write_data_rtl8195bhp_patch (hal_sdio_host_adapter_t *psdioh_adapter, u64 start_addr, u16 blk_cnt, u8 *wbuf_32align);
extern void hal_sdioh_card_insert_hook_rtl8195bhp_patch (hal_sdio_host_adapter_t *psdioh_adapter, sdioh_card_detect pcallback, void *pdata);
#endif
