 ...
 *
 ******************************************************************************/
#ifndef _RTL8195BHP_ETH_H_
#define _RTL8195BHP_ETH_H_
...
#include "rtl8195bhp_ethernet_type.h"
...
hal_status_t hal_eth_pin_ctrl_rtl8195bhp (eth_pin_sel_t pin_sel, BOOL en);
void hal_eth_set_interface_rtl8195bhp (eth_if_sel_t if_sel);
void hal_eth_irq_reg_rtl8195bhp (irq_handler_t irq_handler);
void hal_eth_irq_unreg_rtl8195bhp (void);
void hal_eth_set_desc_num_rtl8195bhp (hal_eth_adapter_t *peth_adapter, u8 tx_desc_no, u8 rx_desc_no);
void hal_eth_set_desc_addr_rtl8195bhp (hal_eth_adapter_t *peth_adapter, u8 *tx_desc, u8 *rx_desc);
void hal_eth_set_pkt_buf_rtl8195bhp (hal_eth_adapter_t *peth_adapter, u8 *tx_pkt_buf, u8 *rx_pkt_buf);
void hal_eth_set_mac_addr_rtl8195bhp (hal_eth_adapter_t *peth_adapter, u8 *addr);
void hal_eth_get_mac_addr_rtl8195bhp (hal_eth_adapter_t *peth_adapter, u8 *addr);
hal_status_t hal_eth_init_rtl8195bhp (hal_eth_adapter_t *peth_adapter, eth_if_sel_t if_sel, eth_pin_sel_t pin_sel);
void hal_eth_deinit_rtl8195bhp (hal_eth_adapter_t *peth_adapter);
s32 hal_eth_write_data_rtl8195bhp (hal_eth_adapter_t *peth_adapter, u8 *data, u32 size);
u32 hal_eth_send_pkt_rtl8195bhp (hal_eth_adapter_t *peth_adapter);
u32 hal_eth_receive_pkt_rtl8195bhp (hal_eth_adapter_t *peth_adapter);
u32 hal_eth_read_data_rtl8195bhp (hal_eth_adapter_t *peth_adapter, u8 *data, u32 size);
u32 hal_eth_get_link_status_rtl8195bhp (hal_eth_adapter_t *peth_adapter);
void hal_eth_set_link_rtl8195bhp (hal_eth_adapter_t *peth_adapter, s32 speed, s32 duplex);
void hal_eth_callback_hook_rtl8195bhp (hal_eth_adapter_t *peth_adapter, eth_callback_t pcallback);
void hal_eth_task_yield_hook_rtl8195bhp (hal_eth_adapter_t *peth_adapter, eth_task_yield task_yield);
...
#endif  // end of "#define _RTL8195BHP_ETH_H_"
