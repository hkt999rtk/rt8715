...
#define IGNORE_STOP_CHK     0xFFFF
#define ENABLE_STOP_CHK     0x1
...
struct usb_iso_request
{
    ...
    uint16_t stop_flag;          /* 0xFFFF to ignore this check */
    uint16_t stop_buf_num;       
};
...
struct usb_ep_ops {
    ...
    int (*iso_ep_start)(struct usb_ep *, struct usb_iso_request *, gfp_t gfp_flags);
 ...
 */
extern  int usb_ep_dequeue (struct usb_ep *ep, struct usb_request *req);
 ...
 */
extern  int usb_ep_set_halt (struct usb_ep *ep);
 ...
 */
extern  int usb_ep_clear_halt (struct usb_ep *ep);
...
struct usb_gadget_driver {
	...
	//Commented    int         (*setup)(dwc_otg_pcd_t *, const struct usb_ctrlrequest *);//ModifiedByJD    
 ...
 * This function must be called in a context that can sleep.
 */
extern  int usb_gadget_unregister_driver (struct usb_gadget_driver *driver);

/**
 * usb_free_descriptors - free descriptors returned by usb_copy_descriptors()
 * @v: vector of descriptors
 */
extern  void usb_free_descriptors(struct usb_descriptor_header **v);
 ...
 */
extern  int gadget_is_dualspeed(struct usb_gadget *g);
#if 0
/**
...
extern  int usb_gadget_get_string (struct usb_gadget_strings *table, int id, u8 *buf);
...
extern  int usb_descriptor_fillbuf(void *, unsigned,
		const struct usb_descriptor_header **);

/* build config descriptor from single descriptor vector */
extern  int usb_gadget_config_buf(const struct usb_config_descriptor *config,
	void *buf, unsigned buflen, const struct usb_descriptor_header **desc);

/*-------------------------------------------------------------------------*/

extern  void set_gadget_data(struct usb_gadget *gadget, void *data);
extern  void *get_gadget_data(struct usb_gadget *gadget);
