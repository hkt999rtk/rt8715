...
#ifndef _RTL8195BH_I2S_H_
#define _RTL8195BH_I2S_H_
...
typedef uint8_t i2s_pin_sel_t;

/**
  \brief I2S application pin mux selection. 
*/
enum  i2s_app_pin_sel_e
{
    I2s_2ch_Ws_Clk_Tx0                  =   0x0,
    I2s_2ch_Ws_Clk_Tx0_Rx               =   0x1,  
    I2s_5p1ch_Ws_Clk_Tx0_Tx1_TX2        =   0x2,     
    I2s_2ch_Ws_Clk_Tx0_Mclk             =   0x3,
    I2s_2ch_Ws_Clk_Tx0_Rx_Mclk          =   0x4,  
    I2s_5p1ch_Ws_Clk_Tx0_Tx1_TX2_Mclk   =   0x5       
};
typedef uint8_t i2s_app_pin_sel_t;
...
typedef struct hal_i2s_adapter_s{
    ...
    I2S0_Type *base_addr;                   /*! The I2S register base address */
    i2s_pin_sel_t pin_sel;                  /*! I2S pin mux seletion */    
    i2s_app_pin_sel_t i2s_app_pin_sel;      /*! I2S Application Pin Mux */
    u8 app_pin_sel_index;                   /*! Application pin index */
...
void hal_i2s_irq_handler_rtl8195bhp (void *hid);
void hal_i2s_irq_reg_rtl8195bhp (void);
void hal_i2s_irq_unreg_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter);
HAL_Status hal_i2s_en_rtl8195bhp (i2s_index_sel_t index_sel, BOOL en);
HAL_Status hal_i2s_clk_ctrl_rtl8195bhp (i2s_index_sel_t index_sel, BOOL en);
HAL_Status hal_i2s_mclk_ctrl_rtl8195bhp (i2s_index_sel_t index_sel, BOOL en);
HAL_Status hal_i2s_pin_ctrl_rtl8195bhp (i2s_index_sel_t index_sel, i2s_pin_sel_t pin_sel, BOOL en);
HAL_Status hal_i2s_rx_pin_ctrl_rtl8195bhp (i2s_index_sel_t index_sel, BOOL en);
HAL_Status hal_i2s_5p1_pin_ctrl_rtl8195bhp (i2s_index_sel_t index_sel, BOOL en);
void hal_i2s_app_pin_ctrl_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter);
HAL_Status hal_i2s_func_ctrl_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, BOOL i2s_func_en);
HAL_Status hal_i2s_init_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter);
HAL_Status hal_i2s_deinit_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter);
void hal_i2s_enter_critical_rtl8195bhp (void);
void hal_i2s_exit_critical_rtl8195bhp (void);
void hal_i2s_set_parameter_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, hal_i2s_def_setting_t *psetting);
void hal_i2s_set_rate_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_sample_rate_t i2s_sample_rate);
void hal_i2s_set_dma_buf_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, u16 i2s_page_size, i2s_page_num_t i2s_page_num);
u8 hal_i2s_get_tx_page_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter);
u8 hal_i2s_get_rx_page_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter);
void hal_i2s_page_send_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, u8 page_idx);
HAL_Status hal_i2s_page_recv_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter);
void hal_i2s_clear_all_own_bit_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter);
void hal_i2s_reset_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter);
void hal_i2s_reset_and_disable_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter);
void hal_i2s_en_ctrl_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, BOOL en);
void hal_i2s_clr_intr_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter);
void hal_i2s_clr_all_intr_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter);
void hal_i2s_intr_ctrl_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_tx_imr_t i2s_tx_intr_msk, i2s_rx_imr_t i2s_rx_intr_msk);
void hal_i2s_read_memory_cache_invalidate_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter);
 ...
 */
__STATIC_INLINE
void hal_i2s_set_word_len_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_word_len_t i2s_word_len)
{    
 ...
 */
__STATIC_INLINE
void hal_i2s_set_ch_num_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_ch_num_t i2s_ch_num)
{    
 ...
 */
__STATIC_INLINE
void hal_i2s_set_page_num_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_page_num_t i2s_page_num)
{    
 ...
 */
__STATIC_INLINE
void hal_i2s_set_page_size_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, u16 i2s_page_size)
{    
 ...
 */
__STATIC_INLINE
void hal_i2s_set_direction_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_direction_t i2s_trx_act)
{    
 ...
 */
__STATIC_INLINE
void hal_i2s_set_format_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_format_t format)
{    
 ...
 */
__STATIC_INLINE
void hal_i2s_set_master_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_dev_mode_t dev_mode)
{    
 ...
 */
__STATIC_INLINE
void hal_i2s_set_lxbus_burst_size_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_burst_size_t burst_size)
{    
 ...
 */
__STATIC_INLINE
void hal_i2s_set_byte_swap_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_byte_swap_t byte_swap)
{    
 ...
 */
__STATIC_INLINE
void hal_i2s_set_sck_inv_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_sck_inv_t sck_inv)
{    
 ...
 */
__STATIC_INLINE
void hal_i2s_set_ws_swap_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_ws_swap_t ws_swap)
{    
 ...
 */
__STATIC_INLINE
void hal_i2s_set_loopback_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_loopback_t loopback)
{    
 ...
 */
__STATIC_INLINE
void hal_i2s_set_data_start_edge_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_edge_sw_t edge_sw)
{    
 ...
 */
__STATIC_INLINE
void hal_i2s_set_mute_rtl8195bhp (hal_i2s_adapter_t *pi2s_adapter, i2s_mute_t mute)
{
...
#endif  // #ifndef _RTL8195BH_I2S_H_
