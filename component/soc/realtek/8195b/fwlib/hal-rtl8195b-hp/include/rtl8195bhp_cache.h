...
#ifndef _RTL8195BH_CACHE_H_
#define _RTL8195BH_CACHE_H_
...
void icache_enable_rtl8195bhp (void);
void icache_disable_rtl8195bhp (void);
void icache_invalidate_rtl8195bhp (void);
void dcache_enable_rtl8195bhp (void);
void dcache_disable_rtl8195bhp (void);
void dcache_invalidate_rtl8195bhp (void);
void dcache_clean_rtl8195bhp (void);
void dcache_clean_invalidate_rtl8195bhp (void);
void dcache_invalidate_by_addr_rtl8195bhp (uint32_t *addr, int32_t dsize);
void dcache_clean_by_addr_rtl8195bhp (uint32_t *addr, int32_t dsize);
void dcache_clean_invalidate_by_addr_rtl8195bhp (uint32_t *addr, int32_t dsize);
...
#endif  // #ifndef _RTL8195BH_CACHE_H_
