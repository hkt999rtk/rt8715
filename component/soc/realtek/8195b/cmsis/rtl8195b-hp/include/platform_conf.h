...
#ifndef _RTL8195BH_CONF_H_
#define _RTL8195BH_CONF_H_
...
#if CONFIG_FPGA
// FPGA
#define XTAL                                (20000000U)      /* Oscillator frequency */
//#define XTAL                                (12500000U)      /* Oscillator frequency */
#define CONFIG_CPU_CLK                      (XTAL)
#define PLATFORM_SCLK                       (XTAL)
#define CHIP_VER                            (CHIP_C_CUT)
#else
// ASIC
#define CONFIG_CPU_CLK                      (300000000U)
#define PLATFORM_SCLK                       (80000000U)
#define CHIP_VER                            (CHIP_C_CUT)
#endif
...
#define CONFIG_I3C_EN                       1
#define CONFIG_PCM_EN                       1
...
#define CONFIG_ICC_NSC_EN                   1       // HAL Non-secure callable function
#define CONFIG_LPDDR_EN                     1
...
#endif
#define STDIO_UART_IDX                      (0)   // STDIO UART port index
#define STDIO_UART_PIN_SEL                  (1)   // STDIO UART port pin selection
...
#define CONFIG_EXRAM_LPDDR_EN               (1)   // is LPDDR memory present on this platform
#define CONFIG_EXRAM_PSRAM_EN               (0)   // is PSRAM memory present on this platform

#define CONFIG_EXRAM_EN                     (CONFIG_EXRAM_LPDDR_EN | CONFIG_EXRAM_PSRAM_EN)   // is enable EXternal RAM (PSRAM/LPDDR)
#if (CONFIG_EXRAM_LPDDR_EN == 1) && (CONFIG_EXRAM_PSRAM_EN == 1)
#error "External RAM type either is LPDDR or PSRAM, they cannot coexistent!"
#endif
...
#define CONFIG_VIDEO_SHMEM_EN               (0)   // is the share memory (0x20140000 ~ 0x20179FFF) used by the Video
...
#define CONFIG_SDMMC_FATFS_EN                1       // is enable FAT32 file system for SD MMC host

#endif  // end of "#define _RTL8195BH_CONF_H_"
