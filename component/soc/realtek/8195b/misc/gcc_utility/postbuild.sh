...
#echo mode=$mode
if [ $mode -eq 1 ]; then
	echo "generate ota_app.bin"
	$1 otamerge application_is/firmware_is.bin application_is/firmware_is.bin application_is/ota_app.bin
	exit
fi
...
if [ $ota = 2 ]; then
	...
	#echo `pwd`
	#echo $1
	$1 otamerge application_is/firmware_is_ota1.bin application_is/firmware_is_ota2.bin application_is/ota_app.bin
	#../../../component/soc/realtek/8195b/misc/iar_utility/elf2bin.exe otamerge application_is/firmware_is_ota1.bin application_is/firmware_is_ota2.bin application_is/ota_app.bin
fi
exit