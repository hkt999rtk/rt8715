...
// LP platform: rt_printf callback variables → ROM stubs (saves ~46KB RAM)
#include "stdio_port.h"
#include "rt_printf.h"

// Light versions — always available in ROM stubs
rt_printf_fn_t    _rt_printfl_fn   = (rt_printf_fn_t)stdio_printf_stubs.rt_printfl;
rt_sprintf_fn_t   _rt_sprintfl_fn  = (rt_sprintf_fn_t)stdio_printf_stubs.rt_sprintfl;
rt_snprintf_fn_t  _rt_snprintfl_fn = (rt_snprintf_fn_t)stdio_printf_stubs.rt_snprintfl;

#if defined(CONFIG_BUILD_SECURE)
// Secure LP: full printf / sscanf not in stubs, fall back to light versions
rt_printf_fn_t    _rt_printf_fn    = (rt_printf_fn_t)stdio_printf_stubs.rt_printfl;
rt_sprintf_fn_t   _rt_sprintf_fn   = (rt_sprintf_fn_t)stdio_printf_stubs.rt_sprintfl;
rt_snprintf_fn_t  _rt_snprintf_fn  = (rt_snprintf_fn_t)stdio_printf_stubs.rt_snprintfl;
rt_sscanf_fn_t    _rt_sscanf_fn    = NULL;   // no sscanf in secure stubs
#else
// Non-secure LP: full versions available in ROM stubs
rt_printf_fn_t    _rt_printf_fn    = (rt_printf_fn_t)stdio_printf_stubs.rt_printf;
rt_sprintf_fn_t   _rt_sprintf_fn   = (rt_sprintf_fn_t)stdio_printf_stubs.rt_sprintf;
rt_snprintf_fn_t  _rt_snprintf_fn  = (rt_snprintf_fn_t)stdio_printf_stubs.rt_snprintf;
rt_sscanf_fn_t    _rt_sscanf_fn    = (rt_sscanf_fn_t)stdio_printf_stubs.rt_sscanf;
#endif
