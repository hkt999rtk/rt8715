...
uint32_t __attribute__((cmse_nonsecure_entry)) TZ_Init_Stack_S (void)
{
	return __Init_Stack_S();
}

SECTION_NS_ENTRY_FUNC
uint32_t __attribute__((cmse_nonsecure_entry)) TZ_Alloc_Stack_S (uint32_t module_id, uint32_t stackdepth)
{
...
SECTION_NS_ENTRY_FUNC
uint32_t __attribute__((cmse_nonsecure_entry)) TZ_Free_Stack_S (uint32_t context_id)
{
	int i;
...
SECTION_NS_ENTRY_FUNC
uint32_t __attribute__((cmse_nonsecure_entry)) TZ_Load_Context_S (uint32_t context_id)
{
	char *give_msp_s;
	char *stack_limit;
...
SECTION_NS_ENTRY_FUNC
uint32_t __attribute__((cmse_nonsecure_entry)) TZ_Store_Context_S (uint32_t context_id)
{
	char *get_msp_s;
	char *stack_limit;
