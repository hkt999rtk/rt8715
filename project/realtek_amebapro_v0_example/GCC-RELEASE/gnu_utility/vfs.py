...
try:
    ...
    print('littlefs Python library is not installed.Please install by command: pip install littlefs-python')
try:
    from pyfatfs.PyFat import PyFat
    from pyfatfs.PyFatFS import PyFatFS
except:
    print('pyfatfs Python library is not installed.Please install by command: pip install pyfatfs')
