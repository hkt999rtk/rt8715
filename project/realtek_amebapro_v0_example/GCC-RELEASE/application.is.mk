...
CARBOX_PATCH_CHACHA ?= 0
ifeq ($(CARBOX_PATCH_CHACHA),1)
CARBOX_CARPLAY_ARCHIVE := $(CARBOX_CARPLAY_CHACHA_DIR)/build/lib_CarPlay_chacha_m33.a
else
# Customer baseline: retain the ChaCha implementation supplied in lib_CarPlay.a.
...
CARBOX_CARPLAY_HANDOVER_ARCHIVE := $(CARBOX_CARPLAY_CHACHA_DIR)/build/lib_CarPlay_vendor_handover.a
endif
